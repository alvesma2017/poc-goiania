...
load_dotenv()
OPENAI_API_KEY = os.getenv("OPENAI_API_KEY")  # Coloque sua chave .env

ASSISTANT_ID = "asst_ke0QLnvj8WvqCvrr2YGB9uHV"  # Substitua pelo seu Assistant ID

def enviar_para_openai(documento_texto, prompt_extra=""):
    prompt_base = """
...
"""
    ...
    # Usando o endpoint de assistants v2 (thread)
    response = openai.chat.completions.create(
        model="gpt-4o",  # Você pode ajustar para o modelo do seu assistant, se desejar
        messages=[
